...
## Project Structure
    ...
    ├── the_computer_tutor_36147  # Django project configurations
...
1. Clone this repo and `cd the_computer_tutor_36147`
...
2. Clone this repo and `cd the_computer_tutor_36147`
